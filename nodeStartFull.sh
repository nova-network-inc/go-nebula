...
nebula --datadir .dag --networkid "87" --config "nebulatestnet.toml" --nodiscover --maxpeers "1" --syncmode "full" --ipcdisable --miner.etherbase "0x000000000000000000000000000000000000dEaD"
